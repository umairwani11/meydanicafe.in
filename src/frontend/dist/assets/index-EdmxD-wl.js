...
function ContactDetail({
  ...
  const iconBox = /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0",
      style: { background: "linear-gradient(135deg, #2B1A12, #3A241A)" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-caramel-light" })
    }
  );
  const textBox = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-caramel font-semibold uppercase tracking-widest mb-0.5", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-espresso font-semibold text-sm", children: value }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-espresso/55 text-xs", children: sub })
  ] });
  if (href) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5 bg-parchment border border-cream-dark rounded-2xl p-5 shadow-card", children: [
    iconBox,
    textBox
  ] });
}
function MenuSection() {
  ...
  const visibleCategories = activeTab === "all" ? MENU_DATA : MENU_DATA.filter((c) => c.id === activeTab);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      id: "menu",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-cream-light relative inline-block", children: [
            "Our Full Menu",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-3 left-1/2 -translate-x-1/2 w-20 h-1 bg-caramel rounded-full" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-cream-light/55 max-w-xl mx-auto text-sm leading-relaxed", children: "From traditional Kashmiri flavours to international favourites — every item is halal-certified and made fresh daily." })
        ] }),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  "data-ocid": "menu.tab",
                  className: `flex-shrink-0 px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 whitespace-nowrap border ${activeTab === "all" ? "bg-caramel text-espresso border-caramel shadow-warm" : "bg-transparent text-cream-light/70 border-cream-light/20 hover:border-caramel/50 hover:text-cream-light"}`,
                  children: "🍽️ All"
                }
              ),
              MENU_DATA.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => setActiveTab(cat.id),
                  "data-ocid": "menu.tab",
                  className: `flex-shrink-0 px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 whitespace-nowrap border ${activeTab === cat.id ? "bg-caramel text-espresso border-caramel shadow-warm" : "bg-transparent text-cream-light/70 border-cream-light/20 hover:border-caramel/50 hover:text-cream-light"}`,
                  children: [
                    cat.emoji,
                    " ",
                    cat.name
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-12", children: visibleCategories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          activeTab === "all" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: cat.emoji }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-caramel-light", children: cat.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-cream-light/10" })
          ] }),
          activeTab !== "all" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl", children: cat.emoji }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-caramel-light", children: cat.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-cream-light/45 text-xs", children: [
                cat.items.length,
                " items"
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-3", children: cat.items.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream-light font-semibold text-sm leading-snug", children: item.name }),
                  item.desc && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream-light/45 text-xs leading-relaxed mt-1", children: item.desc })
                ] }),
                item.price && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 text-caramel font-bold text-sm pt-0.5", children: item.price })
              ]
            },
            `${cat.id}-${idx}`
          )) })
        ] }, cat.id)) }),
        (activeTab === "all" || activeTab === "pizza") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-cream-light/35 text-xs mt-8", children: "* Pizza prices shown as Medium / Large" })
      ] })
    }
  );
}
function App() {
  ...
  const [form, setForm] = reactExports.useState({ name: "", contact: "", message: "" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen font-body bg-cream-light overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        className: `fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-parchment/98 backdrop-blur-md shadow-card py-3" : "bg-parchment/95 backdrop-blur-sm py-4"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "#home",
                ...
                children: "Meydani Cafe"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex items-center gap-7", children: NAV_LINKS.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: link.href,
                  ...
                  children: [
                    link.label,
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-1 left-0 w-0 h-0.5 bg-caramel group-hover:w-full transition-all duration-300" })
                  ]
                }
              ) }, link.href)) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-parchment border-t border-cream-dark shadow-lift", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "flex flex-col py-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "px-6 pt-3 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "url('/assets/generated/meydani-hero.dim_1400x800.jpg')"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(135deg, rgba(33,18,12,0.85) 0%, rgba(43,26,18,0.55) 60%, rgba(33,18,12,0.3) 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-[1200px] mx-auto px-6 pt-24 pb-32", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-caramel-light text-xs font-semibold tracking-[0.3em] uppercase mb-5 opacity-0 animate-fade-up", children: "✦ Srinagar, Jammu & Kashmir ✦" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight max-w-2xl mb-6 opacity-0 animate-fade-up-d1", children: [
              "Welcome to",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-caramel-light", children: "Meydani Cafe" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85 text-base sm:text-lg max-w-xl leading-relaxed mb-10 opacity-0 animate-fade-up-d2", children: "Srinagar's premier destination for authentic Kashmiri hospitality, exceptional coffee, and traditional tea. A place where every cup tells a story." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-up-d3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: "#menu",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(MountainSilhouette, {})
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-espresso relative inline-block", children: [
              "Our Heritage & Values",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-3 left-1/2 -translate-x-1/2 w-20 h-1 bg-caramel rounded-full" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-espresso/60 max-w-xl mx-auto text-sm leading-relaxed", children: "Born from a passion for Kashmiri culture and community, Meydani Cafe is more than a coffee shop — it's a gathering place rooted in warmth, tradition, and values." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center mb-20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-3xl overflow-hidden shadow-lift", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-espresso", children: "A Cafe Rooted in Kashmir" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-espresso/65 leading-relaxed text-sm", children: "Nestled on The Bund Road near Chai Jai, Poloview in Srinagar, Meydani Cafe was founded with a simple vision: to create a space where the rich flavours and warm spirit of Kashmiri hospitality could be shared with everyone." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-espresso/65 leading-relaxed text-sm", children: "Every item on our menu — from our hand-pulled Noon Chai to our house-blend espresso — is crafted with care, authenticity, and a deep respect for the traditions that inspire us." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-10 h-10 rounded-full bg-caramel/20 flex items-center justify-center text-lg", children: "🕘" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-espresso/50 font-medium uppercase tracking-wide", children: "Opening Hours" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-espresso font-semibold text-sm", children: "Daily 10:30 AM – 9:00 PM" })
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: VALUES.map((val, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-5", children: val.emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-xl font-bold text-espresso mb-3", children: val.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-espresso/60 text-sm leading-relaxed", children: val.desc })
              ]
            },
            val.title
          )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        className: "section-reveal py-24 bg-cream-light",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-espresso relative inline-block", children: [
            "Find Us in Srinagar",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-3 left-1/2 -translate-x-1/2 w-20 h-1 bg-caramel rounded-full" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-start", children: [
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      style: {
                        background: "linear-gradient(135deg, #e8ddd0 0%, #f3ebdd 100%)"
                      },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-12 h-12 text-caramel", strokeWidth: 1.5 }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl font-bold text-espresso", children: "The Bund Road, Residency Road" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-espresso/60 text-sm", children: "near Chai Jai, Poloview, Srinagar, J&K 190001" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex flex-col gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-espresso/70 text-sm", children: "We're conveniently located on The Bund Road near Chai Jai, Poloview — easy to find and easier to love." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "a",
                      {
                        href: "https://maps.google.com/?q=Meydani+Cafe+Srinagar",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-5", children: CONTACT_DETAILS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ContactDetail, { ...item, index: i + 1 }, item.label)) })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[580px] mx-auto px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-espresso relative inline-block", children: [
              "Reserve a Table",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -bottom-3 left-1/2 -translate-x-1/2 w-20 h-1 bg-caramel rounded-full" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-espresso/60 text-sm", children: "Drop us a message and we'll confirm your reservation or answer any questions." })
          ] }),
          submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-espresso mb-3", children: "Thank you!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-espresso/65 leading-relaxed text-sm", children: "We've received your message and will be in touch very soon. See you at Meydani Cafe!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-6 pt-16 pb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-3 gap-12 pb-12 border-b border-cream-light/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream-light/50 text-sm leading-relaxed", children: "Authentic Kashmiri hospitality, exceptional coffee, and traditional tea — right in the heart of Srinagar." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-caramel font-semibold text-xs uppercase tracking-widest mb-5", children: "Quick Links" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-caramel font-semibold text-xs uppercase tracking-widest mb-5", children: "Stay Connected" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 mb-6", children: [
                {
                  icon: Instagram,
                  href: "https://instagram.com/meydani_cafe1",
                  label: "Instagram",
              ...
              ].map(({ icon: Icon2, href, label, ocid }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href,
                  target: "_blank",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-cream-light/35 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "© ",
              (/* @__PURE__ */ new Date()).getFullYear(),
              " Meydani Cafe, Srinagar. All rights reserved."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "Built with ❤️ using",
              " ",
    ...
    scrolled && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        style: { background: "linear-gradient(135deg, #2B1A12, #3A241A)" },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-4 h-4 text-caramel" })
      }
    ),
...
const Time = Int;
const RoomType = Variant({
  "familySuite": Null,
  "deluxeRoom": Null,
  "executiveSuite": Null
});
const BookingInquiry = Record({
  "id": Nat,
  "checkIn": Text,
  "name": Text,
  "email": Text,
...
Service({
  "getAllBookings": Func([], [Vec(BookingInquiry)], ["query"]),
  "submitBooking": Func(
    [Text, Text, Text, Text, RoomType, Nat],
    [BookingInquiry],
    []
  )
});
